"""DirectCloud: tc_125 - 검색 링크 범위 필터 동작 확인"""
import json
...
def test_tc_125_search_link_scope(page):
    ...
    try:
        ...
        if detail_btn.count() > 0:
            ...
            link_scope = page.locator('#detail-search-link')
            if link_scope.count() > 0:
                link_scope.first.click()
