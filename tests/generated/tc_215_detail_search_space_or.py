"""DirectCloud: tc_215 - 상세 검색 공간 OR 조건 선택 (#detail-space-or)"""
import json
...
def test_tc_215_detail_search_space_or(page):
    ...
    try:
        ...
        if detail_btn.count() > 0:
            ...
            page.wait_for_timeout(1000)
        space_or = page.locator('#detail-space-or')
        if space_or.count() > 0:
            space_or.first.click(force=True)
