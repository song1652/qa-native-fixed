"""DirectCloud: tc_105 - Shared Box 컨텍스트 메뉴 AI 데이터 관리 항목 확인"""
import json
import pytest
...
def test_tc_105_sharedbox_context_menu_ai_data(page):
    ...
    try:
        ...
        menu_item = page.locator('li:has-text("AI 데이터 관리"), li:has-text("AI 데이터")')
