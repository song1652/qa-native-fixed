"""DirectCloud: tc_124 - 검색 현재 위치 범위 필터 동작 확인"""
import json
...
def test_tc_124_search_current_location_scope(page):
    ...
    try:
        ...
        if detail_btn.count() > 0:
            ...
            current_scope = page.locator('#detail-search-current')
            if current_scope.count() > 0:
                current_scope.first.click()
