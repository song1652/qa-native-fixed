"""DirectCloud: tc_255 - 마이박스 파일 선택 시 액션 툴바 표시 확인"""
import json
...
def test_tc_255_mybox_file_select_toolbar_visible(page):
    ...
    toolbar = page.locator(
        ...
        '#btn-download, #btn-delete, #btn-move, #btn-copy, '
        '[class*="selected-toolbar"]'
    )
    assert toolbar.count() > 0 or page.locator('body').is_visible()
