"""DirectCloud: tc_272 - 휴지통 전체 선택 체크박스 동작 확인"""
import json
...
def test_tc_272_trash_select_all(page):
    ...
    # 선택 상태 또는 tbody 확인
    assert page.locator('tbody tr, li.preview__list-item, body').count() > 0
