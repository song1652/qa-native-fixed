"""DirectCloud: tc_106 - Shared Box 컨텍스트 메뉴 코멘트 설정 항목 확인"""
import json
import pytest
...
def test_tc_106_sharedbox_context_menu_comment(page):
    ...
    try:
        ...
        menu_item = page.locator('li:has-text("코멘트 설정"), li:has-text("코멘트")')
