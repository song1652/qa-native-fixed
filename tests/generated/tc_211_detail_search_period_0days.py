"""DirectCloud: tc_211 - 상세 검색 기간 0일 선택 (#detail-period-0)"""
import json
...
def test_tc_211_detail_search_period_0days(page):
    ...
    try:
        ...
        if detail_btn.count() > 0:
            ...
            page.wait_for_timeout(1000)
        # 기간 0일 선택
        period_0 = page.locator('#detail-period-0')
        if period_0.count() > 0:
            period_0.first.click(force=True)
