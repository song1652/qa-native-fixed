"""DirectCloud: tc_107 - Shared Box 컨텍스트 메뉴 즐겨찾기 해제 항목 확인"""
import json
import pytest
...
def test_tc_107_sharedbox_context_menu_unfavorite(page):
    ...
    try:
        ...
        menu_item = page.locator('li:has-text("즐겨찾기 해제"), li:has-text("즐겨찾기")')
