"""DirectCloud: tc_176 - 마이박스 파일 우클릭 삭제 컨텍스트 메뉴"""
import json
...
def test_tc_176_mybox_file_delete_context_menu(page):
    ...
    if file_item.count() > 0:
        ...
        delete_menu = page.locator(':text("삭제")')
        assert delete_menu.count() > 0
